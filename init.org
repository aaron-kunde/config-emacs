...
- [[https://emacs-lsp.github.io/lsp-mode/page/lsp-bash/][Bash]]: Installation of https://github.com/bash-lsp/bash-language-server, [[https://www.shellcheck.net/][ShellCheck]] should be installed before as a dependency.
